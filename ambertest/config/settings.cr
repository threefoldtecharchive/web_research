...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Ambertest web application."
  #
  #
  ...
  #
  # settings.secret_key_base= w6kjOAG-nH18yidysmW-xA7yf9ujl0pCF8FqTLX2p_o
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("ambertest.log", "w"))
  #
  #
end
